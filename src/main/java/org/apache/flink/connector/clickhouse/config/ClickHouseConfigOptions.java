...
public class ClickHouseConfigOptions {
    ...
    public static final ConfigOption<Boolean> APPEND_OP =
        ConfigOptions.key(ClickHouseConfig.APPEND_OP)
            .booleanType()
            .defaultValue(Boolean.FALSE)
            .withDescription("append op kind");

    public static final ConfigOption<Boolean> CDAS_FLAG =
        ConfigOptions.key(ClickHouseConfig.CDAS_FLAG)
            .booleanType()
            .defaultValue(Boolean.FALSE)
            .withDescription("cdas flag");
